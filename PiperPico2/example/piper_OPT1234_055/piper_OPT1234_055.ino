...
void setup() 
  {
     ...
     //-------------------------------------------------------ปรับทิมเซอร์โว
      ...
      Set_distanceFW_to_turnGyro(45);   //---->> ตั้งค่าระยะเดินออกจากเส้นก่อนหมุนตัวหลังจากใช้ คำสั่งsetrobot_bw(2);
      Set_distanceBW_to_turnGyro(115);  //---->> ตั้งค่าระยะเดินออกจากเส้นก่อนหมุนตัวหลังจากใช้ คำสั่งsetrobot_fw(2);

      set_pid_turnL(0.832f, 0.0001f, 0.150f);   //-->>  ตั้งค่า pid ในการหมุนตัว  
      set_pid_turnR(0.832f, 0.0001f, 0.150f);   //  หมุนแรงน้อยไปไม่ถึง เพิ่มค่าตัวแรก  
